...
/* ===== END FIREBASE MODULE ===== */
(function(){
if(!sessionStorage.getItem('skpps_auth')||sessionStorage.getItem('skpps_role')!=='mgmt'){location.href='../staff-login-v2.html'}
...
window.logout=function(){sessionStorage.clear();location.href='../staff-login-v2.html'};
