...
function renderDashboard(){
  ...
  return '<div class="panel active">'+
    ...
    '<div class="quick-acts">'+
      '<button class="qact qa-red" onclick="navTo(\'scan\')"><span class="qa-ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke-width="2"><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/></svg></span><span class="qa-info"><span class="qa-t">Scan ID Card</span><span class="qa-s">OCR auto-fill student data</span></span></button>'+
      '<button class="qact qa-blue" onclick="navTo(\'import\')"><span class="qa-ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke-width="2"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg></span><span class="qa-info"><span class="qa-t">Bulk Import</span><span class="qa-s">CSV upload multiple students</span></span></button>'+
      '<button class="qact qa-green" onclick="navTo(\'teachers\')"><span class="qa-ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span><span class="qa-info"><span class="qa-t">Manage Teachers</span><span class="qa-s">Add teacher accounts</span></span></button>'+
      '<button class="qact qa-yellow" onclick="navTo(\'students\')"><span class="qa-ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></span><span class="qa-info"><span class="qa-t">View Students</span><span class="qa-s">'+S.length+' students enrolled</span></span></button>'+
    '</div>'+
